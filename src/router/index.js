    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    meta: { requiresAuth: true, roles: ['DOSEN', 'KAPRODI', 'SUPER_ADMIN', 'STAF_AKADEMIK'], title: 'Nilai Akhir Mata Kuliah' }
                },
                {
...
router.beforeEach(async (to, from, next) => {
    const defaultTitle = import.meta.env.VITE_APP_NAME || 'CampusCore';
